                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Group</p>
                                    <h5 class="font-weight-bolder">
                                        {{ $totalGroup }}
                                    </h5>
                                    <p class="mb-0">
                                        <span class="text-success text-sm font-weight-bolder">&nbsp</span>
                                    </p>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <p class="mb-0">
                                        <span class="text-danger text-sm font-weight-bolder">&nbsp</span>
                                    </p>
                                </div>
                            </div>
                            <div class="col-4 text-end">
