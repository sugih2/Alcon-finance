...
<div class="p2">
    ...
    <div class="footer">
        ...
        <button type="button" onclick="storeemployeeRun()" id="btn-save" class="btn btn-primary">Submit</button>
    </div>
</div>
...
<script>
    ...
    function storeemployeeRun() {
        data = selectedEmployees;
    }

    async function storeemployeeRun() {
        ...
        console.log('Isi Data Karyawan:', selectedEmployees);

        try {
            const csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content');

            // Kirim data sebagai JSON
            const response = await fetch('/run-payroll/store-employee', {
                method: 'POST',
                headers: {
